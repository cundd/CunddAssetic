...
})()(
  {
          ...
          _createClass(LessPlugin, [
            ...
            },
            {
              ...
              value: function reloadLess(path) {
                ...
                for (
                  var _i2 = 0, _Array$from2 = Array.from(links);
        ...
        var LiveReload = /*#__PURE__*/ (function () {
          function LiveReload(window) {
            ...
            if ("LiveReloadOptions" in window) {
              ...
              for (
                var _i = 0,
                  _Object$keys = Object.keys(window.LiveReloadOptions || {});
              ...
              Timer,
              {
                ...
                connected: function connected(protocol) {
                  ...
                  var port = _this.options.port
                    ? ":".concat(_this.options.port)
                    : "";
                  _this.log(
                    "LiveReload is connected to "
                      .concat(host)
                      .concat(port, " (protocol v")
                      .concat(protocol, ")."),
                  );
                  ...
                  switch (reason) {
                    case "cannot-connect":
                      return _this.log(
                        "LiveReload cannot connect to "
                          .concat(host)
                          .concat(port, ", will retry in ")
                          .concat(nextDelay, " sec."),
                      );
                    case "broken":
                      return _this.log(
                        "LiveReload disconnected from "
                          .concat(host)
                          .concat(port, ", reconnecting in ")
                          .concat(nextDelay, " sec."),
                      );
                    case "handshake-timeout":
                      return _this.log(
                        "LiveReload cannot connect to "
                          .concat(host)
                          .concat(port, " (handshake timeout), will retry in ")
                          .concat(nextDelay, " sec."),
                      );
                    case "handshake-failed":
                      return _this.log(
                        "LiveReload cannot connect to "
                          .concat(host)
                          .concat(port, " (handshake failed), will retry in ")
                          .concat(nextDelay, " sec."),
                      );
                    case "manual": // nop
                    case "error": // nop
          ...
          _createClass(LiveReload, [
            ...
            },
            {
              ...
              value: function performReload(message) {
                ...
                return this.reloader.reload(message.path, {
                  ...
                  reloadMissingCSS:
                    message.reloadMissingCSS != null
                      ? message.reloadMissingCSS
                      : true,
            ...
            },
            {
              ...
              value: function shutDown() {
                ...
                return typeof this.listeners.shutdown === "function"
    ...
    107: [
      function (require, module, exports) {
        ...
        Options.extract = function (document) {
          for (
            var _i = 0,
              _Array$from = Array.from(document.getElementsByTagName("script"));
            _i < _Array$from.length;
            _i++
          ) {
            ...
            if (
              (m = src.match(lrUrlRegexp)) &&
              (mm = srcAttr.match(lrUrlRegexpAttr))
            ) {
              var _m = m,
                ...
                try {
                  ...
                  if (!this.protocol) {
                    ...
                    if (data.match(new RegExp("^!!ver:([\\d.]+)$"))) {
                      ...
                      (message = this._parseMessage(data, ["hello"]))
                    ) {
                      if (!message.protocols.length) {
                        ...
                        Array.from(message.protocols).includes(PROTOCOL_7)
                      ) {
                        this.protocol = 7;
                      } else if (
                        Array.from(message.protocols).includes(PROTOCOL_6)
                      ) {
                        this.protocol = 6;
                      } else {
                  ...
                  if (this.protocol === 6) {
                    ...
                    return this.handlers.message({
                      ...
                      path: options.path,
                      liveCSS:
                        options.apply_css_live != null
                          ? options.apply_css_live
                          : true,
                    });
                  }
            ...
            },
            {
              ...
              value: function _parseMessage(data, validCommands) {
                ...
                if (!validCommands.includes(message.command)) {
                  throw new ProtocolError(
                    "invalid command '"
                      .concat(message.command, "', only valid commands are: ")
                      .concat(validCommands.join(", "), ")"),
                    data,
                  );
                }
                return message;
          ...
          _createClass(Reloader, [
            ...
            },
            {
              ...
              value: function reload(path) {
                ...
                for (
                  var _i = 0, _Array$from = Array.from(this.plugins);
                  _i < _Array$from.length;
                  _i++
                ) {
            ...
            },
            {
              ...
              value: function reloadImages(path) {
                ...
                for (
                  var _i2 = 0, _Array$from2 = Array.from(this.document.images);
                  _i2 < _Array$from2.length;
                  _i2++
                ) {
                ...
                if (this.document.querySelectorAll) {
                  for (
                    var _i3 = 0, _IMAGE_STYLES = IMAGE_STYLES;
                    _i3 < _IMAGE_STYLES.length;
                    _i3++
                  ) {
                ...
                if (this.document.styleSheets) {
                  return Array.from(this.document.styleSheets).map(
                    function (styleSheet) {
                      return _this2.reloadStylesheetImages(
                        styleSheet,
                        path,
                        expando,
                      );
            ...
            },
            {
              ...
              value: function reloadStylesheetImages(
                styleSheet,
                path,
                expando,
              ) {
                ...
                for (
                  var _i5 = 0, _Array$from4 = Array.from(rules);
                  _i5 < _Array$from4.length;
                  _i5++
                ) {
                  ...
                  try {
                    switch (rule.type) {
                      ...
                      case CSSRule.STYLE_RULE:
                        for (
                          var _i6 = 0, _IMAGE_STYLES2 = IMAGE_STYLES;
                          _i6 < _IMAGE_STYLES2.length;
                          _i6++
                        ) {
            ...
            },
            {
              ...
              value: function reloadStyleImages(
                style,
                styleNames,
                path,
                expando,
                      ...
                      var newValue = value.replace(
                        ...
                        function (match, src) {
                          if (pathsMatch(path, pathFromUrl(src))) {
                            return "url(".concat(
                              _this3.generateCacheBustUrl(src, expando),
                              ")",
                            );
                          }
                          return match;
            ...
            },
            {
              ...
              value: function reloadStylesheet(path) {
                ...
                var links = (function () {
                  ...
                  for (
                    var _i7 = 0,
                      _Array$from5 = Array.from(
                        _this4.document.getElementsByTagName("link"),
                      );
                    _i7 < _Array$from5.length;
                    _i7++
                  ) {
                ...
                for (
                  var _i8 = 0,
                    _Array$from6 = Array.from(
                      this.document.getElementsByTagName("style"),
                    );
                  _i8 < _Array$from6.length;
                  _i8++
                ) {
                ...
                for (
                  var _i9 = 0, _Array$from7 = Array.from(links);
                  _i9 < _Array$from7.length;
                  _i9++
                ) {
                ...
                if (this.window.StyleFix && this.document.querySelectorAll) {
                  for (
                    var _i10 = 0,
                      _Array$from8 = Array.from(
                        this.document.querySelectorAll("style[data-href]"),
                      );
                    _i10 < _Array$from8.length;
                    _i10++
                  ) {
                ...
                this.console.log(
                  "LiveReload found "
                    .concat(links.length, " LINKed stylesheets, ")
                    .concat(imported.length, " @imported stylesheets"),
                );
                var match = pickBestMatch(
                  path,
                ...
                if (match) {
                  ...
                  if (options.reloadMissingCSS) {
                    ...
                    for (
                      var _i11 = 0, _Array$from9 = Array.from(links);
                      _i11 < _Array$from9.length;
                      _i11++
                    ) {
            ...
            },
            {
              ...
              value: function collectImportedStylesheets(
                link,
                styleSheet,
                result,
              ) {
            ...
            },
            {
              ...
              value: function waitUntilCssLoads(clone, func) {
                ...
                return this.Timer.start(
                  options.stylesheetReloadTimeout,
                  executeCallback,
                );
              },
            },
              ...
              value: function reattachStylesheetLink(link) {
                ...
                return this.waitUntilCssLoads(clone, function () {
                  ...
                  return _this6.Timer.start(additionalWaitingTime, function () {
                    ...
                    return _this6.window.StyleFix
                      ? _this6.window.StyleFix.link(clone)
                      : undefined;
                  });
                }); // prefixfree
              },
            },
            {
              ...
              value: function reattachImportedRule(_ref) {
                ...
                var media = rule.media.length
                  ? [].join.call(rule.media, ", ")
                  : "";
                var newRule = '@import url("'
                  .concat(href, '") ')
                  .concat(media, ";");
                ...
                return this.Timer.start(
                  ...
                  function () {
                    ...
                    return _this7.Timer.start(
                      _this7.importCacheWaitPeriod,
                      function () {
                        // if another reattachImportedRule call is in progress, abandon this one
                        if (rule.__LiveReload_newHref !== href) {
                          return;
                  ...
                  if (url.indexOf(options.serverURL) < 0) {
                    ...
                    this.console.log(
                      "LiveReload is overriding source URL "
                        .concat(originalUrl, " with ")
                        .concat(url),
                    );
                  }
                }
                var params = oldParams.replace(
                  /(\?|&)livereload=(\d+)/,
                  function (match, sep) {
    ...
    110: [
      function (require, module, exports) {
        ...
        var LiveReload = (window.LiveReload =
